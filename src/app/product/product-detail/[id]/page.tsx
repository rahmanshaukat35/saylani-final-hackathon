...
export default function Page({
  ...
  return (
    <div className="w-full h-full dark:text-black lg:h-screen bg-gray-200 py-4 px-2">
      <div className="text-sm breadcrumbs py-3 px-2 ">
        <ul>
          <li>
            <Link href={"/"}>
              <svg
      ...
      <div className="w-full   h-full lg:h-4/5 py-4 px-4 flex items-center justify-center">
        {isLoading ? (
          ...
          <div className="lg:w-4/5 w-full h-full  bg-gray-200 rounded-xl lg:h-4/5 flex flex-col lg:flex-row items-center justify-center shadow-xl  ">
            ...
            <div className="lg:w-8/12 w-full px-3 h-full  rounded flex flex-col lg:px-5 py-2">
              <div className="flex flex-col  lg:flex-row md:justify-between w-full md:h-20 py-2 items-center">
                ...
                {prodData?.productFeatured && (
                  <p className="px-3 py-2 bg-gray-600 hidden lg:flex font-semibold tracking-widest rounded text-white  items-center justify-center ">
                    <DiCodeigniter className="mx-2" />
                    Featured Product
                  </p>
                )}
              </div>
              <p className=" py-2   lg:h-40 w-full text-gray-600">
              ...
              <h1 className="text-3xl font-semibold text-gray-600 py-2">
                Color:
                <span className="mx-5 text-2xl">{prodData?.productColor}</span>
              </h1>
              <h1 className="text-3xl font-semibold text-gray-600 py-2">
                {prodData?.ProductSize}
              </h1>
              <h1 className="text-3xl font-semibold text-gray-600 py-2">
                Price:
                <span className="mx-5 text-2xl">
              ...
              <div className="w-full py-2 lg:flex-row flex-col flex ">
                <button
                  onClick={AddToCart}
                  className="btn m-2 lg:w-52 h-10 btn-success flex items-center justify-center"
                >
