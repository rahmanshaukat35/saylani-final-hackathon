...
export default function AdminSidebar() {
  ...
  return (
    <div className="w-60 hidden dark:text-gray-600 md:block bg-white h-full space-y-12">
      <div className="w-full text-center py-3 px-3 h-15 ">
        <h1 className="flex text-2xl font-semibold items-center justify-center">
          <RxDashboard className="mx-2" /> Admin-Dashboard
        </h1>
      </div>
